...
export class AvatarScrollZoomout {
    ...
    ngOnInit(){
        ...
        this.renderer.setStyle(this.imageHandle, 'width', (window.innerWidth/2)+'px');
        this.renderer.setStyle(this.imageHandle, 'height', (window.innerWidth/2)+'px');
        this.renderer.setStyle(this.scrollerHandle,'margin-top',this.marginTop+'px');
    ...
    updateAvatarZoomOut(){
        ...
        this.renderer.setStyle(this.imageHandle, 'width', height+'px');
        this.renderer.setStyle(this.imageHandle, 'height', height+'px');
        this.renderer.setStyle(this.scrollerHandle,'margin-top',(((height - this.avatarHeight) + this.marginTop))+'px'); //+this.adjustment
        this.renderer.setStyle(this.scrollerHandle,'padding-top','0');
        this.renderer.setStyle(this.avatar, 'webkitTransform', 'translate3d(0,-'+this.translateAmt+'px,0) ');
